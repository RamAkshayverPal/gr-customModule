...
#ifndef INCLUDED_CUSTOMMODULE_OFDM_EQUALIZER_SIMPLEDFE_H
#define INCLUDED_CUSTOMMODULE_OFDM_EQUALIZER_SIMPLEDFE_H

#include <gnuradio/customModule/api.h>
#include <gnuradio/customModule/constellation.h>
 ...
 *
 */
class CUSTOMMODULE_API ofdm_equalizer_simpledfe : public ofdm_equalizer_1d_pilots
{
public:
    typedef std::shared_ptr<ofdm_equalizer_simpledfe> sptr;

    ofdm_equalizer_simpledfe(int fft_len,
                             const gr::customModule::constellation_sptr& constellation,
...
private:
    gr::customModule::constellation_sptr d_constellation;
...
#endif /* INCLUDED_CUSTOMMODULE_OFDM_EQUALIZER_SIMPLEDFE_H */
