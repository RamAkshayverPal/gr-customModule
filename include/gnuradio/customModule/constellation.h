...
#ifndef INCLUDED_CUSTOMMODULE_CONSTELLATION_H
#define INCLUDED_CUSTOMMODULE_CONSTELLATION_H
 ...
 */
class CUSTOMMODULE_API constellation : public std::enable_shared_from_this<constellation>
{
public:
    ...
    virtual void calc_metric(const gr_complex* sample,
                             float* metric,
                             gr::customModule::trellis_metric_type_t type);
 ...
 * constellations.
 */
class CUSTOMMODULE_API constellation_calcdist : public constellation
{
public:
...
/*!
 * \brief Sectorized customModule constellation
 * \ingroup customModule
 *
 * \details
 ...
 */
class CUSTOMMODULE_API constellation_sector : public constellation
{
public:
    /*!
...
/*!
 * \brief Rectangular customModule constellation
 * \ingroup customModule
 *
 ...
 * too large.
 */
class CUSTOMMODULE_API constellation_rect : public constellation_sector
{
public:
 ...
 */
class CUSTOMMODULE_API constellation_expl_rect : public constellation_rect
{
public:
 ...
 */
class CUSTOMMODULE_API constellation_psk : public constellation_sector
{
public:
 ...
 * \verbatim
   ...
   \endverbatim
 */
class CUSTOMMODULE_API constellation_bpsk : public constellation
{
public:
 ...
 * \verbatim
   ...
   \endverbatim
 */
class CUSTOMMODULE_API constellation_qpsk : public constellation
{
public:
 ...
 * \verbatim
   ...
   \endverbatim
 */
class CUSTOMMODULE_API constellation_dqpsk : public constellation
{
public:
 ...
 * \verbatim
   ...
   \endverbatim
 */
class CUSTOMMODULE_API constellation_8psk : public constellation
{
public:
 ...
 * \verbatim
   ...
   \endverbatim
 */
class CUSTOMMODULE_API constellation_8psk_natural : public constellation
{
public:
...
0011   0110 | 0111   0010
   \endverbatim
 */
class CUSTOMMODULE_API constellation_16qam : public constellation
{
public:
...
#endif /* INCLUDED_CUSTOMMODULE_CONSTELLATION_H */
