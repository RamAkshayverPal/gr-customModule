...
#ifndef INCLUDED_CUSTOMMODULE_CONTROL_LOOP_H
#define INCLUDED_CUSTOMMODULE_CONTROL_LOOP_H
 ...
 * intended to act as a parent class to customModule which need a control
 ...
 * +/-2pi).
 */
class CUSTOMMODULE_API control_loop
{
protected:
...
#endif /* INCLUDED_CUSTOMMODULE_CONTROL_LOOP_H */
