...
#include "ofdm_frame_equal_vcvc_impl.h"
...
ofdm_frame_equal_vcvc::sptr
ofdm_frame_equal_vcvc::make(ofdm_equalizer_base::sptr equalizer,
                                int cp_len,
                                const std::string& len_tag_key,
                                bool propagate_channel_state,
                                int fixed_frame_len)
{
    return gnuradio::make_block_sptr<ofdm_frame_equal_vcvc_impl>(
        equalizer, cp_len, len_tag_key, propagate_channel_state, fixed_frame_len);
}

ofdm_frame_equal_vcvc_impl::ofdm_frame_equal_vcvc_impl(
...
void ofdm_frame_equal_vcvc_impl::parse_length_tags(
...
int ofdm_frame_equal_vcvc_impl::work(int noutput_items,
