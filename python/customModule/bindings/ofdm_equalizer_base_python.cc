...
/* BINDTOOL_HEADER_FILE_HASH(677b38889edd65a7504c2a23d429d242)                     */
/***********************************************************************************/
...
void bind_ofdm_equalizer_base(py::module& m)
{
    ...
    using ofdm_equalizer_base = ::gr::customModule::ofdm_equalizer_base;
    using ofdm_equalizer_1d_pilots = ::gr::customModule::ofdm_equalizer_1d_pilots;
    ...
    py::class_<ofdm_equalizer_base, std::shared_ptr<ofdm_equalizer_base>>(
        ...
        // )
        // .def(py::init<gr::customModule::ofdm_equalizer_base const &>(), py::arg("arg0"),
    ...
    py::class_<ofdm_equalizer_1d_pilots,
               gr::customModule::ofdm_equalizer_base,
        ...
        // )
        // .def(py::init<gr::customModule::ofdm_equalizer_1d_pilots const &>(),
        // py::arg("arg0"),
