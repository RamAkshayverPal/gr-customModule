...
/* BINDTOOL_HEADER_FILE_HASH(a0d35f2728a5d4e459262aa4c50d9d6d)                     */
/***********************************************************************************/
...
void bind_control_loop(py::module& m)
{
    ...
    using control_loop = ::gr::customModule::control_loop;
    ...
    py::class_<control_loop, std::shared_ptr<control_loop>>(
        ...
        .def(py::init<gr::customModule::control_loop const&>(),
             py::arg("arg0"),
    ...
    m.def("tanhf_lut", &::gr::customModule::tanhf_lut, py::arg("x"), D(tanhf_lut));
}
